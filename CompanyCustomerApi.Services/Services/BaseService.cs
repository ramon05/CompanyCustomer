using CompanyCustomerApi.BI.Extensions;
...
namespace CompanyCustomerApi.Services.Services
{
    public interface IBaseService<TEntity, TDto>
    {
        ...
        Task<IEntityOperationResult<TDto>> DeleteByAsync(int id);
        IMapper _mapper { get; }
    }
        ...
        where TDto : class, IBaseDto
    {
        ...
        public async Task<IEntityOperationResult<TDto>> DeleteByAsync(int id)
        {
            var entity = await _repository.Get(id);
